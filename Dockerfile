...
LABEL org.opencontainers.image.description="MCP server for Swarm postage stamp management and provenance data storage"
LABEL org.opencontainers.image.version="${VERSION}"
LABEL org.opencontainers.image.vendor="Datafund"
LABEL org.opencontainers.image.source="https://github.com/datafund/swarm_provenance_MCP"
